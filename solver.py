...
class Solver(object):
    ...
    def train(self):
        ...
        if self.resume_iters:
            ...
            g_path = os.path.join(self.model_save_dir, '0-G.ckpt')
            d_path = os.path.join(self.model_save_dir, '0-D.ckpt')
